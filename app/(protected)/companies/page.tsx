  ...
  return (
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <SearchForm onSearch={handleSearch} initialValues={Object.fromEntries(searchParams.entries())} />
          ...
          <div className="space-y-4">
            <div className="bg-white shadow-sm border border-gray-200 rounded-lg overflow-hidden">
              <div className="p-4 bg-gray-50 border-b border-gray-200 font-semibold text-gray-700">
                Results ({data.totalCount || (Array.isArray(data) ? data.length : (data.items?.length || 0))})
              </div>
